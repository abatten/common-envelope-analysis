...
def read_inlist(ipath):
    ...
    output_file_name = config.get('Energy', 'output_file_name')
    output_file_append = config.getboolean('Energy', 'output_file_append')
    use_smoothed_potential = config.getboolean('Energy', 'use_smoothed_potential')
    smoothing_length = config.getfloat('Common', 'smoothing_length')
    select_primary = config.getboolean('Energy', 'select_primary')
