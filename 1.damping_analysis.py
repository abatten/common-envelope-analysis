...
def density_slice_along_z(profile, radial_profile, ce, str_index):
	sp = SlicePlot(profile, 'z', "Density", center=[0.3916, 0.54199, 0.53027], width = 1.0) #centered in the center of the axis
...
#        sp.annotate_image_line((0.0, 0.5), (1.0, 0.5), plot_args={'linewidth':1,'color':'black'})
        sp.save(plot_dir + "density_slice_z_find_spike_" + str_index + ".png")
...
def grav_potential_slice_along_z(profile, radial_profile, ce, str_index):
        ...
        sp = SlicePlot(profile, 'z', "Grav_Potential", width = 1.0) #centered in the center of the axis
